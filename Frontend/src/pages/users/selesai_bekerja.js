...
function selesai_bekerja() {
  return (
    <div className="selesai_bekerja">
              ...
              <div className="sub-content-rumah-3">
                <div className="container" style={{ backgroundColor: "white" }}>
                  <div className="row header-content">
                    <h4>Presensi pulang sudah tercatat!</h4>
                  ...
                  <div className="footer-sub-content">
                    <button
                      ...
                      type="button"
                      onClick={() => {
                        window.location.href = "/beranda"; // Navigasi ke laman masuk_kerja
                      }}>
                      Tutup
                    </button>
                  </div>
...
export default selesai_bekerja;
