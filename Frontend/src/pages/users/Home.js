...
const handleUploadButtonClick = async () => {
  ...
  try {
    const response = await axios.post("http://localhost:8081/api/v1/presence", {
      id_msib: idMsib,
      username: username,
      shift: shift,
      divisi: divisi,
      ...
      <div className="content-home">
        <div className="form-content-home">
          ...
          <div className="sub-content-2">
            ...
            <button className="btn btn-primary" style={{ borderWidth: 2, borderColor: "white" }} onClick={changeToFormIzinKerja}>
              Pengajuan Izin
            </button>
            <button className="btn btn-primary" style={{ borderWidth: 2, borderColor: "white" }} onClick={changeToRekapPresensi}>
              Rekap Presensi
            </button>
          </div>
        </div>
        ...
        <div className="image-content">
          <div className="homepage">
              ...
              <div className="camera">
                <div className="camera-title">
                  ...
                  <div className="camera-button d-flex justify-content-evenly">
                    <button className="cancel-cam-btn" onClick={handleCancelButtonClick}>
                      Batal
                    </button>
                    <button className="capture-btn" onClick={handleCaptureButtonClick}></button>
                    <button className="upload-cam-button" onClick={handleUploadButtonClick}>
                      Upload
                    </button>
                  </div>
                </div>
              ...
              <div className="camera">
                <div className="camera-title">
                  ...
                  <div className="camera-button d-flex justify-content-evenly">
                    ...
                    <button className="capture-btn d-none" onClick={handleCaptureButtonClick}></button>
                    <button className="upload-cam-button" onClick={handleUploadButtonClick}>
                      Upload
                    </button>
                  </div>
            ...
            {showFormMasukKerja && (
              <div className="sub-content-3">
                <div className="border-sub-content">
                  <div className="container-lg" style={{ backgroundColor: "white", borderRadius: 20 }}>
                      ...
                      <div className="row py-1 d-flex justify-content-center ">
                        <div className="col ">
                          <div class="mb-3">
                            ...
                            <input readOnly type="text" class="form-control" id="IDK" aria-describedby="emailHelp" value={idMsib} />
                          </div>
                        </div>
                        <div className="col">
                          <div class="mb-3">
                            ...
                            <input readOnly type="text" class="form-control" id="pres_masuk" aria-describedby="emailHelp" value={formattedTime} />
                          </div>
                        </div>
                      </div>
                      <div className="row py-2">
                        <div className="col">
                          <div class="mb-3">
                            ...
                            <input readOnly type="text" class="form-control" id="div" aria-describedby="emailHelp" value={divisi} />
                          </div>
                        </div>
                        <div className="col">
                          <div class="mb-3">
                  ...
                  <div className="hp-button">
                    <button className="btn-done-working me-2 " type="button" onClick={handleDoneWorkButtonClick}>
                      Selesai Bekerja
                    </button>
                  </div>
                </div>
            ...
            {showFormSelesaiKerja && (
              <div className="sub-content-3">
                <div className="container-lg" style={{ backgroundColor: "white", borderRadius: 20 }}>
                  ...
                  <div className="hp-button">
                    <button className="btn-done-working me-2 " type="button" onClick={handleCloseWorkButtonClick}>
                      Tutup
                    </button>
                  </div>
                </div>
                      ...
                      <div className="row py-1">
                        <div className="col">
                          <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="IDK" aria-describedby="emailHelp" value={idMsib} />
                          </div>
                        </div>
                        <div className="col">
                          <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="pres_masuk" aria-describedby="emailHelp" value={formattedTime} />
                          </div>
                        </div>
                      </div>
                      <div className="row py-2">
                        <div className="col">
                          <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="div" aria-describedby="emailHelp" value={divisi} />
                          </div>
                        </div>
                        <div className="col">
                          <div class="mb-3">
            ...
            {!showCamera && !capturedImage && !showFormMasukKerja && !showFormSelesaiKerja && !showFormIzinKerja && !showFormRekapPresensi && !showFormTelatKerja && (
              <div className="homepage">
