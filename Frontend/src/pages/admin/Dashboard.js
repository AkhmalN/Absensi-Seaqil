...
import { faBars, faCaretDown, faCheck, faCogs, faFilePdf, faList, faMagnifyingGlass, faSignOut, faUser, faXmark } from "@fortawesome/free-solid-svg-icons";
    ...
    <>
      <div id="wrapper" className={isSideBarOpen ? "toggled" : ""}>
        ...
        <div id="content-wrapper" className="d-flex flex-column">
          <div id="content" style={{ marginLeft: isSideBarOpen ? "150px" : "300px" }}>
                    ...
                    <Dropdown.Toggle variant="white">
                      <Row className="d-flex align-content-end">
                        ...
                        <Col xs="1" className="mt-2 ps-3">
                          <FontAwesomeIcon icon={faCaretDown} className="sub-header_profile d-none d-lg-inline text-left " />
                        </Col>
                      </Row>
                    </Dropdown.Toggle>
                    ...
                    <div className="card-body">
                      <div className="row no-gutters align-items-center">
                        <div className="col mr-2">
                          <div className="text-xs font-weight-bold text-primary text-uppercase mb-1">Presensi Hari Ini</div>
                ...
                <div className="col-xl-3 col-md-6 mb-4">
                  <div className="card border-left-success shadow h-100 py-2">
                    <div className="card-body">
                      <div className="row no-gutters align-items-center">
                        <div className="col mr-2">
                          <div className="text-xs font-weight-bold text-success text-uppercase mb-1">Terlambat</div>
                ...
                <div className="col-xl-3 col-md-6 mb-4">
                  <div className="card border-left-info shadow h-100 py-2">
                    <div className="card-body">
                      <div className="row no-gutters align-items-center">
                        <div className="col mr-2">
                          <div className="text-xs font-weight-bold text-info text-uppercase mb-1">Pengajuan Izin</div>
                          <div className="row no-gutters align-items-center">
                            <div className="h5 mb-0 font-weight-bold text-gray-800">2</div>
                          </div>
                        </div>
                ...
                <div className="col-xl-3 col-md-6 mb-4">
                  <div className="card border-left-warning shadow h-100 py-2">
                    <div className="card-body">
                      <div className="row no-gutters align-items-center">
                        <div className="col mr-2">
                          <div className="text-xs font-weight-bold text-warning text-uppercase mb-1">Mahasiswa Magang</div>
              ...
              <div className="card shadow mb-4">
                ...
                <div className="card-header py-3 d-flex justify-content-between bg-white">
                  ...
                  <form className="d-flex align-items-center form-inline mr-0 mw-100 navbar-search">
                    <button className="check me-2" type="button" onClick={handleShowAdd}>
                ...
                <div className="card-body ">
                  ...
                  >
                    ...
                    <Column field="IDk" header="ID Kegiatan" style={{ width: "15%" }} alignHeader={"center"}></Column>
                    <Column field="shift" header="Shift" style={{ width: "11%" }} alignHeader={"center"}></Column>
                    <Column field="nm" header="Nama" style={{ width: "17%" }} alignHeader={"center"}></Column>
                    <Column field="div" header="Divisi" style={{ width: "16%" }} alignHeader={"center"}></Column>
                    <Column field="jk" header="Jam Keluar" style={{ width: "11%" }} alignHeader={"center"}></Column>
                    <Column field="stat_p" header="Status" style={{ width: "11%" }} alignHeader={"center"}></Column>
                    <Column
                      field="aksi"
                      header="Aksi"
                      style={{ width: "16%" }}
                      ...
                      body={(rowData) => (
                        ...
                        >
                          <button className="check me-2 " type="button" onClick={handleShowEdit}>
            ...
            <Modal show={showDelete} onHide={handleCloseDelete} aria-labelledby="contained-modal-title-vcenter" centered size="sm">
              <Modal.Body>
                ...
                <div className="modal-body text-center">Anda yakin menghapus data ini?</div>
                <div className="d-flex justify-content-center mt-2" style={{ border: "none" }}>
                  ...
                  <button className="decline ms-2" onClick={handleShowAlertDelete}>
                    Yakin
                  </button>
                </div>
              </Modal.Body>
            ...
            <Modal show={showAlertDelete} onHide={handleCloseAlertDelete} aria-labelledby="contained-modal-title-vcenter" centered size="sm">
              <Modal.Body>
                ...
                <div className="modal-body text-center">Data Berhasil Dihapus!</div>
              </Modal.Body>
            </Modal>
              ...
              <Modal.Body className="modal-body">
                <Modal.Body>
                  <div className="modal-header-edit text-center mb-3">
                    ...
                    <div className="mt-3">
                      <div class="mb-2">
                        <input type="text" className="form-control" id="IdK" placeholder="ID Kegiatan" />
                      </div>
                      <div class="mb-2">
                        <input type="text" className="form-control" id="nm" placeholder="Nama Lengkap" />
                      </div>
                      <div class="mb-2">
                        <input type="text" className="form-control" id="div" placeholder="Divisi" />
                      </div>
                      <div class="mb-2">
                  ...
                  <div className="d-flex justify-content-center mt-4" style={{ border: "none" }}>
                    ...
                    <button className="edit-btn ms-2" onClick={handleShowAlertEdit}>
                      Simpan
                    </button>
                  </div>
                </Modal.Body>
            ...
            {/* BERHASIL EDIT */}
            <Modal show={showAlertEdit} onHide={handleCloseAlertEdit} aria-labelledby="contained-modal-title-vcenter" centered size="sm">
              <Modal.Body>
                <div className="modal-header-decline text-center">
                  <img src={checkmark} alt="checkmark" className="icon_check" />
                </div>
                <div className="modal-body text-center">Data Berhasil Diedit!</div>
              </Modal.Body>
            </Modal>
            {/* END OF BERHASIL EDIT */}

            {/* BUTTON ADD PERSON */}
            <Modal show={showAdd} onHide={handleCloseAdd} aria-labelledby="contained-modal-title-vcenter" centered size="sm">
              <Modal.Body className="modal-body">
                <Modal.Body>
                  <div className="modal-header-edit text-center mb-3">
                    Tambah Data
                  ...
                  <div className="d-flex justify-content-center mt-4" style={{ border: "none" }}>
                    ...
                    <button className="edit-btn ms-2" onClick={handleShowAlertAdd}>
                      Simpan
                    </button>
                  </div>
                </Modal.Body>
            ...
            {/* BERHASIL ADD */}
            <Modal show={showAlertAdd} onHide={handleCloseAlertAdd} aria-labelledby="contained-modal-title-vcenter" centered size="sm">
              <Modal.Body>
                <div className="modal-header-decline text-center">
                  <img src={checkmark} alt="checkmark" className="icon_check" />
                </div>
                <div className="modal-body text-center">Data Berhasil Ditambahkan!</div>
              </Modal.Body>
            </Modal>
            {/* END OF BERHASIL ADD */}
                ...
                <div className="card shadow mb-4">
                  ...
                  <div className="card-body ">
                    ...
                    >
                      ...
                      <Column field="nm" header="Nama" style={{ width: "17%" }} alignHeader={"center"}></Column>
                      <Column field="div" header="Divisi" style={{ width: "16%" }} alignHeader={"center"}></Column>
                      <Column field="jm" header="Jam Masuk" style={{ width: "11%" }} alignHeader={"center"}></Column>
                      <Column field="stat_p" header="Status" style={{ width: "11%" }} alignHeader={"center"}></Column>
                      <Column
                        field="aksi"
                        header="Aksi"
            ...
            <div className="dashboard-section" id="pengajuan izin">
              <div className="card shadow mb-4">
                ...
                <div className="card-body ">
                  ...
                  >
                    <Column field="no" header="No" style={{ width: "3%" }}></Column>
                    <Column field="IDk" header="ID Kegiatan" style={{ width: "11%" }} alignHeader={"center"}></Column>
                    <Column field="tgl" header="Tanggal" style={{ width: "11%" }} alignHeader={"center"}></Column>
                    <Column field="nm" header="Nama" style={{ width: "15%" }} alignHeader={"center"}></Column>
                    <Column field="div" header="Divisi" style={{ width: "11%" }} alignHeader={"center"}></Column>
                    <Column
                      field="file"
                      header="File"
                      style={{ width: "9%" }}
                    ...
                    <Column field="alasan" header="Alasan" style={{ width: "15%" }} alignHeader={"center"}></Column>
                    <Column
                      field="aksi"
                      header="Aksi"
                      style={{ width: "15%" }}
