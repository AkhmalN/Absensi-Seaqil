...
import { faBars, faMagnifyingGlass, faPenToSquare, faPrint, faTrashCan } from "@fortawesome/free-solid-svg-icons";
              ...
              <div className="card shadow mb-4 ">
                ...
                <div className="card-header py-3 d-flex justify-content-between bg-white">
                  ...
                  <form className="d-flex align-items-center form-inline mr-0 mw-100 navbar-search">
                    <button className="print-button" type="button" style={{ marginRight: "16px" }}>
                ...
                <div className="card-body ">
                  ...
                  >
                    ...
                    <Column field="IDk" header="ID Kegiatan" style={{ width: "12%" }} alignHeader={"center"}></Column>
                    ...
                    <Column field="shift" header="Shift" style={{ width: "1O%" }} alignHeader={"center"}></Column>
                    <Column field="pass" header="Password" style={{ width: "20%" }} alignHeader={"center"}></Column>
                    <Column
                      field="aksi"
                      header="Aksi"
                      style={{ width: "20%" }}
                      ...
                      body={(rowData) => (
                        ...
                        >
                          <button className="edit me-2" type="button" onClick={handleShowEdit}>
