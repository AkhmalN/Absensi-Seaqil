          ...
          <div id="content">
            ...
            <Modal
              ...
              <Modal.Body className="modal-body">
                <Modal.Body>
                  <div className="modal-header-edit text-center">
                    EDIT DATA
                  ...
                  <div
                    ...
                    style={{ border: "none" }}>
                    <button className="batal me-2" onClick={handleCloseDelete}>
                      Batal
                    </button>
                    <button className="edit ms-2" onClick={handleCloseDelete}>
                      Yakin
                    </button>
                  </div>
                </Modal.Body>
            ...
            <Modal
              ...
              <Modal.Body>
                ...
                <div
                  ...
                  <button className="decline ms-2" onClick={handleCloseDelete}>
                    Yakin
                  </button>
                </div>
              </Modal.Body>
