      ...
      <div id="wrapper">
        ...
        <div id="content-wrapper" className="d-flex flex-column">
          ...
          <div id="content">
                ...
                <div className="nav-item dropdown no-arrow">
                  <Dropdown show={isDropdownOpen} onToggle={toggleDropdown}>
                    <Dropdown.Toggle variant="white">
                      {/* PHONE */}
                      <Row className="d-flex align-content-end d-xl-none">
                        <Col className="col-3">
                          <img
                            src={profil}
                            alt="logo"
                      ...
                      <Row className="">
                        ...
                        <Col className="mt-1 col-6 d-none d-xl-block">
                          <Row>
                          ...
                          <Row>
                            <span className="sub-header_profile">
                              Koordinator
                            </span>
                          </Row>
                        </Col>
                        <Col className="mt-2 ps-3 col-3 d-none d-xl-block">
                          <FontAwesomeIcon
                            icon={faCaretDown}
            ...
            {/* Begin Page Content */}
            <div
              className="container-fluid admin-bg w-100 d-none d-xl-block"
              id="beranda">
            ...
            {/* ON PHONE */}
            <div className="container-fluid admin-bg w-100 d-xl-none">
              <div className="card shadow mb-4 ">
                <div className="card-header py-3 d-flex justify-content-between bg-white ">
                  <div className="header tulisan">
                    <Row className="mb-3">
                    ...
                    <Row className="mb-1">
                      <div className="header">Data Mahasiswa</div>
                    </Row>
                    <Row className="mb-1">
                      <span className="blue-tag ms-2 col-5">MSIB Batch 5</span>
                    </Row>
                    <Row className="mb-3">
                      <div className="sub-header">SEAMEO QITEP In Language</div>
                    </Row>
